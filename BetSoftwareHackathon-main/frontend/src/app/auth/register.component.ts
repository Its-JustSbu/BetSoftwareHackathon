    ...
    <div class="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div class="max-w-md w-full space-y-8">
        ...
        <div class="text-center">
          <div class="mx-auto h-12 w-12 bg-emerald-600 rounded-full flex items-center justify-center">
          ...
          <p class="mt-2 text-sm text-gray-600">
            Join us and start managing your bills together
          </p>
        </div>
        ...
        <form class="mt-8 space-y-6" (ngSubmit)="onSubmit()">
          ...
          <div class="text-center">
            <p class="text-sm text-gray-600">
              ...
              <a routerLink="/auth/login" class="font-medium text-emerald-600 hover:text-emerald-500 transition-colors duration-200">
                Sign in here
              </a>
            </p>
          </div>
        ...
        <div class="mt-6">
          <div class="relative">
            ...
            <div class="relative flex justify-center text-sm">
              <span class="px-2 bg-gradient-to-br from-green-50 to-emerald-100 text-gray-500">
                Or register with
              </span>
            </div>
          </div>
